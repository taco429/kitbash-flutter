...
1. **Draw & Income**: Draw 1 card; reset Mana to 0; collect Mana and Gold from buildings (Tower and Command Center for Mana; Command Center and Barracks for Gold). Gold adds to your bank; Mana is available only for this round.
